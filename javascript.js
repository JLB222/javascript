...
//Day 1095
//review
function trim1095(str) {
  return str.split(",").slice(1, -1).join(" ") || null
}
function lineupStudents1095(students){
  return students.split(" ").sort((a,b) => b.localeCompare(a)).sort((a,b) => b.length - a.length, 0)
}

//7 - What is the flag? - https://www.codewars.com/kata/61efc02e4fd88600343b5c58/train/javascript
...
//Day 1096
//7 - Odd or Even? Determine That! - https://www.codewars.com/kata/619f200fd0ff91000eaf4a08/train/javascript
...
//Day 1152
//7 - Stones on the Table - https://www.codewars.com/kata/5f70e4cce10f9e0001c8995a/train/javascript
...
//Day 1142
//WIP - pickaxe shop
function shop3(materials, store, inventory, budget) {
  //find all store items that have higher dmg than your best; put their names and prices in a variable; betterPickaxes
...
//Day 1147
//WIP
function shop4(materials, store, inventory, budget) {
  //find all store items that have higher dmg than your best; put their names and prices in a variable; betterPickaxes
  let myBestPickaxe = [...inventory][0]  //initializes as the first thing in your inventory; it doesn't have to be your best; we just need a value that won't bork the for of loop below
  let betterPickaxes = []
  for (let pickaxe of inventory) {
  ...
  //check budget after selling weakest owned pickaxe, then compare again
    //if there is no bestPossiblePurchase, return None
    //if there is, return ["bestPossiblePurchase", {"OnesYouSold"}, remainingMoney]
  let sortedInventory = [...inventory].sort((a,b) => materials[a][1] - materials[b][1]) //sort inventory by weakest to strongest
...
//Day 1168
//8 - Job Matching 1 incomplete - https://www.codewars.com/kata/56c22c5ae8b139416c00175d/train/javascript
...
//Day 1169
function match_1169(candidate, job) {
...
//Day 1204
//8 - long name - https://www.codewars.com/kata/574b1916a3ebd6e4fa0012e7/train/javascript
...
//Day 1223
//r
function findCaterer_1223(budget, people){
  let basic = 15 * people
  let economy = 20 * people
  let premium = (people > 60 ? 24 : 30) * people
...
//Day 1250
function howManydays_1250(month){
  let days;
  switch (month){
    case 4:
    case 6:
...
//Day 1252
//8 - force of gravity - https://www.codewars.com/kata/5b609ebc8f47bd595e000627/javascript
...
//Day 1256
//8 - XCOM - https://www.codewars.com/kata/67b7a527c9f842fd3b02adb8/train/javascript
// speed of aircraft is given in *knots*
// travelTime is in *minutes*
// travel distance should be returned in *kilometers*
function travelDistance(avgSpeed, travelTime) {
  const KM_PER_MILE = 1.609344;
  const travelHours = travelTime / 60;
  const travelMiles = (avgSpeed * 1.15078) * travelHours;  //knots are now converted to MPH
  const travelKms   = travelMiles * KM_PER_MILE;  //miles now multiplied by KM per mile instead of divided
...
//Day 1270
//r
function getDivisorsCnt_1270(n){
  let counter = 0
  for (let i = 1; i <= n; i++) {
    if (n % i === 0) {
      counter++
